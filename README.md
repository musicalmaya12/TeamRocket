...
Currently, the Statistics page breaks down the metrics between positive and negative playlists, as determined by the sentiment analysis algorithm. The first chart records how accurate the playlists matched the sentiment of the mood. The more times a playlist is re-generated, the less accurate the algorithm is for the sentiment. The second chart is a breakdown of how many times a user chose "too negative" (sad face) or "too positive" (happy face) for a generated playlist. This gives further detail about what sentiment the algorithm tends to skew toward. 
